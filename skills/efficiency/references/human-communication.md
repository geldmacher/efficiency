...
Write for a person with mixed technical knowledge who may not know the task history.

- Lead with the outcome or decision.
- Before drafting, identify whether the reader needs to act, decide, or understand; let that purpose determine the order and useful level of detail.
- Explain what the outcome means for the user's goal when the implication is not obvious.
...
- Use headings, lists, or tables only when they make choices, mappings, or sequences easier to scan.
